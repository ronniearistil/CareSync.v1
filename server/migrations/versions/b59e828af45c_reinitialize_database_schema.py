...
Revision ID: b59e828af45c
Revises: 
Create Date: 2024-12-11 12:16:41.496103
...
def upgrade():
    ...
    sa.Column('role', postgresql.ENUM('Provider', 'Patient', 'Admin', name='user_roles'), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('email')
    )
